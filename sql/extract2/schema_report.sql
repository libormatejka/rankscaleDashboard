...
--               sql/extract2/transform_report.sql (L1)
-- ============================================================
...
-- ------------------------------------------------------------
-- L1_report_table  (L1 — full refresh po každém extractu)
-- Grain: brand × topic × snapshot_date (deduplikováno přes business_key)
-- ------------------------------------------------------------
CREATE TABLE IF NOT EXISTS `libor-matejkacz.RankScaleDashboard.L1_report_table`
(
  unique_row_id    STRING,
  business_key     STRING,
  owning_brand_id  STRING,
